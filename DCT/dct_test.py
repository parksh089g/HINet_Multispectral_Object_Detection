...
svim(imgs2 ,'./image_check6.jpeg') #최종 이미지
svim(dct_imgs ,'./image_check5.jpeg') #최종 이미지

# Y=np.transpose(Y, (1,2,0))
# imgs2=np.transpose(imgs2,(1,2,0))
# dct_imgs=np.transpose(dct_imgs,(1,2,0))
# Y = tensor_to_image(Y)
# imgs2 = tensor_to_image(imgs2)
# dct_imgs = tensor_to_image(dct_imgs)
# print(Y.shape)
# print(imgs2.shape)
# print(dct_imgs.shape)
# Y.save('./1.jpg')
# imgs2.save('./2.jpg')
# dct_imgs.save('./3.jpg')