...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='LLVIP_R.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='./LLVIP_detect/rgb', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='./LLVIP_detect/ir', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--name', default='LLVIP_MHT', help='save results to project/name')
