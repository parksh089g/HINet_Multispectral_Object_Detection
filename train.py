...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_fusion_transformerx3_FLIR_aligned_dct_res.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='FLIR+RCABxRES', help='save to project/name')
